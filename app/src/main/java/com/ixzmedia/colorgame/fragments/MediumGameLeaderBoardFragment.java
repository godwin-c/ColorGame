...
public class MediumGameLeaderBoardFragment extends Fragment {


    SwipeRefreshLayout frag_medium_swipe_refresh;
    RecyclerView frag_medium_recycler_view;
    ...
    public static MediumGameLeaderBoardFragment newInstance(String param1, String param2) {
        MediumGameLeaderBoardFragment fragment = new MediumGameLeaderBoardFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_medium_game_leader_board, container, false);

        frag_medium_swipe_refresh = (SwipeRefreshLayout) view.findViewById(R.id.frag_medium_swipe_refresh);
        frag_medium_recycler_view = (RecyclerView) view.findViewById(R.id.frag_medium_recycler_view);
    ...
    private void setActionsOnViewItems() {
        ...
        frag_medium_swipe_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        frag_medium_swipe_refresh.setColorSchemeResources(
...
//                            medium
                            frag_medium_swipe_refresh.setRefreshing(false);
    ...
    private void setupRecyclerView(ArrayList<HighScoreModelResponse> easyHighScores) {
        ...
        if (frag_medium_recycler_view.getAdapter() == null || frag_medium_recycler_view.getAdapter().getItemCount() < 1){
            ...
            frag_medium_recycler_view.addItemDecoration(new VerticalSpace(20));
            frag_medium_recycler_view.setAdapter(adapter);
        }else {
            adapter = (HighScoreAdapter) frag_medium_recycler_view.getAdapter();
